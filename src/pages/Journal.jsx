    ...
    <div className="min-h-screen bg-gradient-to-b from-pink-50 to-white p-6">
      <div className="max-w-4xl mx-auto">
        ...
        <motion.div
          ...
          className="mb-10"
        >
          <h1 className="text-3xl font-bold text-[#4A1228] mb-2">Journal</h1>
            ...
            <CardContent className="space-y-6">
              ...
              <div>
                ...
                <Textarea
                  ...
                  className="min-h-[200px] rounded-xl border-gray-200 focus:border-[#6B1B3D] focus:ring-[#6B1B3D]"
                />
              </div>
              ...
              <AnimatePresence>
                {aiResponse && (
                  <motion.div
                    ...
                    animate={{ opacity: 1, y: 0 }}
                    exit={{ opacity: 0, y: -10 }}
                    className="bg-gradient-to-r from-pink-50 to-purple-50 rounded-xl p-6 border border-pink-100"
                  >
                    <div className="flex items-center gap-2 mb-3">
                      <Sparkles className="w-5 h-5 text-[#6B1B3D]" />
                      <span className="font-medium text-[#4A1228]">Reflection</span>
                    </div>
              ...
              <Button
                ...
                className="w-full bg-gradient-to-r from-[#6B1B3D] to-[#8B2E4D] text-white py-6"
              >
                {isProcessing ? (
                  <>
        ...
        >
          <h2 className="text-xl font-bold text-[#4A1228] mb-6">Past Entries</h2>
                      ...
                      {isExpanded && journalEntry.aiResponse && (
                        <div className="mt-4 bg-pink-50 rounded-lg p-4">
                          <div className="flex items-center gap-2 mb-2">
                            ...
                            <span className="text-sm font-medium text-[#4A1228]">Reflection</span>
                          </div>
