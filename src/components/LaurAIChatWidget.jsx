    ...
    <>
      ...
      <AnimatePresence>
        {!isOpen && (
          <motion.button
            ...
            className="fixed bottom-6 right-6 w-16 h-16 bg-[#6B1B3D] hover:bg-[#4A1228] rounded-full shadow-2xl flex items-center justify-center z-50 transition-colors"
          >
      ...
      <AnimatePresence>
        {isOpen && (
          ...
          >
            {/* Header */}
            <div className="bg-gradient-to-r from-[#6B1B3D] to-[#8B2E4D] p-4 flex items-center justify-between">
            ...
            <div className="p-4 bg-white border-t">
              <div className="flex gap-2">
                ...
                <Button
                  ...
                  className="bg-[#6B1B3D] hover:bg-[#4A1228] rounded-full w-10 h-10 p-0"
                >
