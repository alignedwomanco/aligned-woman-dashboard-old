      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <div className="absolute -bottom-6 -right-6 bg-gradient-to-br from-[#6E1D40] to-[#943A59] rounded-2xl p-6 text-white shadow-xl">
          ...
          >
            <div className="inline-flex items-center gap-2 bg-[#F5E8EE] border border-[#DEBECC] rounded-full px-5 py-2 mb-6">
              ...
              <span style={{ color: '#6E1D40' }} className="text-sm font-medium">Is This For You?</span>
            </div>
            ...
            <p className="text-lg text-gray-600 mb-10 font-light">
              ...
              but <span className="font-semibold" style={{ color: '#6E1D40' }}>no longer wants to sacrifice herself to get there</span>.
            </p>
            ...
            <ul className="space-y-4">
              {qualifiers.map((item, index) => (
                ...
                >
                  <div className="w-8 h-8 bg-[#F5E8EE] rounded-full flex items-center justify-center flex-shrink-0">
                    <Check className="w-4 h-4" style={{ color: '#6E1D40' }} />
                  </div>
